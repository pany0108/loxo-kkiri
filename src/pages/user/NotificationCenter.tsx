  ...
  return (
    <div className="flex flex-col min-h-screen bg-white dark:bg-gray-950 font-['Pretendard']">
      ...
      <div className="flex-1 relative overflow-hidden z-0 bg-white dark:bg-gray-950">
        ...
        <div
          ref={containerRef}
          className={`relative h-full pb-[calc(10rem+max(env(safe-area-inset-bottom),32px))] overflow-y-auto overscroll-y-contain z-10 flex flex-col ${
      ...
      {!isSelectionMode && notifications.length > 0 && (
        <footer className="fixed bottom-0 left-0 right-0 px-4 pt-4 pb-[calc(1rem+max(env(safe-area-inset-bottom),32px))] bg-white/80 dark:bg-gray-950/80 backdrop-blur-md z-20 text-center border-t border-gray-100 dark:border-gray-800/50">
