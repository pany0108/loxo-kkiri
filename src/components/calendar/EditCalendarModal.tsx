    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-5">
      ...
      <div className="relative w-full max-w-sm bg-white dark:bg-gray-800 rounded-4xl pt-6 pb-8 px-8 shadow-2xl animate-in zoom-in-95 duration-200">
        <div className="flex justify-between items-center mb-2">
          <h3 className="text-xl font-black text-main dark:text-white">캘린더 수정</h3>
          <div className="flex items-center">
            {!calendar.isDefault && (
              <button onClick={onDelete} className="p-2 text-sub hover:text-red-500 rounded-full transition-colors" title="캘린더 삭제">
                <Trash2 size={20} />
              </button>
            )}
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="relative" ref={colorDropdownRef}>
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 bg-white dark:bg-gray-800 rounded-lg border border-gray-100 dark:border-gray-700 shadow-sm active:scale-95 transition-all"
              >
        ...
        <div className="flex gap-3 mt-8">
          ...
          <button onClick={handleSave} className="flex-1 py-4 bg-primary text-white font-bold rounded-xl shadow-lg shadow-primary/30 dark:shadow-primary/20">
            저장
          </button>
        </div>
      </div>
