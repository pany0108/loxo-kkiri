  ...
  return (
    <section className="bg-gray-50 dark:bg-gray-800 rounded-[28px] p-6 mb-8 border border-gray-100 dark:border-gray-700/50">
      <div className="flex items-center gap-2 mb-3">
        <span className="text-[10px] font-bold text-blue-500 dark:text-blue-300 bg-blue-100 dark:bg-blue-900/50 px-2 py-1 rounded-md">SUMMARY</span>
      </div>
      <h3 className="text-[18px] font-black text-gray-900 dark:text-white mb-2">{title}</h3>

      <div className="space-y-3 mb-4">
        {description && (
          <div className="flex items-start gap-2.5">
            <AlignLeft size={16} className="text-gray-400 dark:text-gray-500 mt-0.5 shrink-0" />
            <p className="text-[14px] font-medium text-gray-600 dark:text-gray-300 leading-relaxed whitespace-pre-wrap">{description}</p>
          </div>
        )}
        {location && (
          <div className="flex items-start gap-2.5">
            <MapPin size={16} className="text-gray-400 dark:text-gray-500 mt-0.5 shrink-0" />
            <p className="text-[14px] font-medium text-gray-600 dark:text-gray-300 leading-relaxed">{location}</p>
          </div>
        )}
      </div>
