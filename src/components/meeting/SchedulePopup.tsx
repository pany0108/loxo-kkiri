    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-5 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-sm bg-white dark:bg-gray-800 rounded-[32px] p-6 shadow-2xl">
        ...
        <div className="flex gap-3 mt-6">
          <button onClick={onClose} className="flex-1 py-3.5 bg-gray-100 dark:bg-gray-700 text-[#8B95A1] dark:text-gray-300 font-bold rounded-[18px] text-sm">
            닫기
          </button>
          <button
            onClick={() => onConfirm(date)}
            className="flex-1 py-3.5 bg-[#007AFF] text-white font-bold rounded-[18px] text-sm shadow-lg shadow-[#007AFF]/30 dark:shadow-blue-900/50"
          >
            이 날짜 선택하기
          </button>
        </div>
