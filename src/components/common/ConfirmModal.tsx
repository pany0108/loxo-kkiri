...
const ConfirmModal: React.FC<ConfirmModalProps> = ({
  ...
  onConfirm,
  icon,
  iconContainerClassName = 'bg-gray-100 text-gray-500 dark:bg-gray-700 dark:text-gray-400',
  title,
  message,
  confirmText = '확인',
  cancelText = '취소',
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-5">
      ...
      <div className="relative w-full max-w-[340px] bg-white dark:bg-gray-800 rounded-[32px] p-8 text-center shadow-2xl animate-in zoom-in-95 duration-200">
        ...
        <div className="flex flex-col gap-2">
          <button onClick={onConfirm} className={`w-full py-4 text-white font-bold rounded-[20px] active:scale-95 transition-all ${confirmButtonClassName}`}>
            {confirmText}
          </button>
